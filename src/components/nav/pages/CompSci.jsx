export default function CompSci(props) {
    ...
    return <div className="full-page ">
        ...
        <p>Participated in team of four to develop a study aid for linguistics students. Designed prototype and tested UX with target users. 
            Implemented quiz question flow and data loader after performing data wrangling process</p>
